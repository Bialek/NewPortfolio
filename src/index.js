...
library.add(fab, faHome, faEnvelope, faGithub, faLinkedinIn, faWpforms, faGitSquare, faMobileAlt, faChartBar, faDesktop, faFilePdf, faLaptopCode, faGraduationCap, faReact, faComment, faExclamationTriangle)
