      ...
      projects: [
        {
          ...
          description:
            'Projekt zbudowany od podstaw. Aplikacja służy do tworzenia katalogów zdjęć po przez wyszukiwaną fraze. Zdjęcia w katalogu może sortować według trzech wartości. Korzystamy tutaj z Api z strony Unsplash. W projekcje wykorzystałem: React, Redux, Redux-thunk oraz Styled-component.',
          img: [
        ...
        },
        {
          ...
          description:
            'Jeden z projektów zrealizowanych na Bootcampie Kodilla. Do projektu samodzielnie dodałem asynchroniczne pobieranie danych z zewnetrznego Api, przez co ilość państw wzrosła z 8 do ponad 250. Dodałem również style z zrealizowane przy użyciu Styled-Component oraz podstrone z ulubionymi państwami.',
          img: [
        ...
        },
        {
          name: 'Hero Rent App',
          description:
            'Aplikacja do wynajmowania superbohaterów. Wykonana w czystym JS ES6, do styly wykorzystałem SCSS i BEM. Zawartość koszyka jest zapisywana do LocalStorage. Backend w NodeJS. Projekt realizowany dla Intive Patronage.',
          img: [
        ...
        },
        {
          name: 'Photo-layout',
          description:
            'Moja autorska wersja strony całkowicie odmienna od pliku PSD który dostałem, strone zrealizowałem z biblioteką Fullpage.js, pozostałe elementy dynamiczne wykonane w jQuery. Style wykonane w Scss. Stylom brakuje metodologii :(',
          img: [
        ...
        },
        {
          name: 'ZTP-layout',
          description:
            'Zadanie rektutacyjne, zrealizowane na podstawie dostarczonego pliku PSD. Style wykonane w Sass, metodologia BEM. Projekt poddany walidacji. Framework JavaScript to jQuery. Na projekt miałem zaledwie 4 dni.',
          img: [
        ...
        },
        {
          name: 'Portfolio',
          description:
            'To portfolio, zbudowane na ReactJS. Style wykonane w Styled-Components. Animacja tła wykonane Kod CSS.',
          img: [
            '/images/projects/ZTP-layout/1.jpg',
            '/images/projects/ZTP-layout/2.jpg',
            '/images/projects/ZTP-layout/3.jpg',
